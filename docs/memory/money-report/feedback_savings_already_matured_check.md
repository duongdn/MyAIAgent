...
metadata:
  ...
  modified: 2026-08-28T03:00:50.991Z
---
...
**🔴 Recurred 2026-08-28:** same exact "nam á 6m" ghost balance was included again in the portfolio/dashboard savings total despite this memory existing — the run's data-processing step didn't check `endDate` before listing savings. Reinforcing: ALWAYS filter `endDate < today` out of savings totals as step 1 of building the Savings section, before writing any numbers to a report.

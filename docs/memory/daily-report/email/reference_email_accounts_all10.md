...
- davidztv19@gmail.com — added 2026-07-06 for **Arthur - Meta-Stamp** project (Workstream "Crystal lang", roster DuongDN/PhucVT/TienND — see [[feedback_workstream_vs_sheets_migration_gaps]]). No filter, flag all mail. Stored password is a regular Google password, not an App Password — if IMAP auth fails, likely needs an App Password generated on that account (2FA).

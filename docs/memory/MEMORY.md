...
- [project_memory_index_organized_by_command.md](project_memory_index_organized_by_command.md) — This index is grouped by command/piece, not topic — read only Global + the matching section

...
- [feedback_marginal_daily_shortfall_check_weekly.md](feedback_marginal_daily_shortfall_check_weekly.md) — Marginal daily shortfall (<1h): check weekly total first — if weekly ≥ target−1h, NOT an alert (LeNH Jun19: 7.33h Fri, 1 day off → target=32h; total=32h = on target)

...
- [feedback_larion_valuation_confirmed_by_user](money-report/feedback_larion_valuation_confirmed_by_user.md) — 🔴 wallet normally inactive; user toggles active to bump value then re-deactivates — 0/inactive ≠ real loss

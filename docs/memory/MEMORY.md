...
- [feedback_timeline_system](global/feedback_timeline_system.md) — update timelines every run
...
- [feedback_kai_daily_report_gate](feedback_kai_daily_report_gate.md) — 🔴 UN-RETIRED 260713: check Workstream Maddy hours first, only check Slack report if he worked that day
...
- [feedback_workstream_all_projects_in_script](daily-report/sheets/feedback_workstream_all_projects_in_script.md), [feedback_dev_project_mapping_flexible](daily-report/sheets/feedback_dev_project_mapping_flexible.md) — scan ALL sheets+WS by owner, never hardcode; 🔴 260715: fixed substring-match bug (TuanNT matched TuanNTG)
...
- [feedback_check_workstream_before_flagging_shortfall](daily-report/sheets/feedback_check_workstream_before_flagging_shortfall.md), [feedback_marginal_daily_shortfall_check_weekly](daily-report/sheets/feedback_marginal_daily_shortfall_check_weekly.md), [feedback_no_dated_scan_scripts](daily-report/sheets/feedback_no_dated_scan_scripts.md) — 🔴×11 260714: AM 0h-then-populated = likely late data entry not API flakiness, recheck later before calling it a bug
...
- [feedback_trello_per_client_gates_on_lead_dev](daily-report/trello/feedback_trello_per_client_gates_on_lead_dev.md), [feedback_philip_msteams_must_run](daily-report/trello/feedback_philip_msteams_must_run.md), [feedback_philip_msteams_duplicate_contacts](daily-report/trello/feedback_philip_msteams_duplicate_contacts.md) — ✅ FIXED 260714: script auto-disambiguates via config customerHints map, no more manual workaround needed

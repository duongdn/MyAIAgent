# Asset Allocation — 2026-05-21 10:48 (updated)
...
| 📈 ETF (VCBS) | ~750,448,575 | **~9.5%** | VN30 + VN100 + VN1000 qua VCBS |
| 🥇 Vàng | 817,500,000 | **10.3%** | 50 units |
| 🏢 Cổ phiếu | 600,000,000 | **7.6%** | Larion cổ phần (cổ tức) |
| 🏛️ Fund (VCBF) | ~594,063,000 | **~7.5%** | VCBF managed fund |
| 📊 Cổ tức stocks (FPTS) | ~236,136,000 | **~3.0%** | VEA + ADP cổ tức + ETF nhỏ |
| 🏛️ Fund (Finhay) | ~74,404,069 | **~0.9%** | Finhay fund |
| 💵 Tiền mặt | 191,574,467 | **2.4%** | Paypal USD + vcb + Ví + Momo |
| 💳 Nợ (VCB Visa) | 24,990,000 | **0.3%** | Credit card, tháng 5 cao nhất 12m |

**Total (incl. ETF/Fund/Cổ tức):** ~8,047,388,882 ₫  
**Net (excl. debt):** ~8,022,398,882 ₫  
*(vs totaldashboard 7,897M — ~125M diff do cost-basis vs market-value của ETF/Fund)*
...
### 📈 ETF (VCBS) — ~750,448,575 ₫ *(cost basis)*

Đầu tư index ETF qua VCBS brokerage. Net = tổng "Cho ETF vay" − "ETF trả nợ".

| Index | Ghi chú |
|-------|---------|
| VN30 | Mua định kỳ từ Dec 2025, lượng lớn nhất Jan 2026 (178M) |
| VN100 | Mua nhiều đợt Dec 2025 – Mar 2026 |
| VN1000 | Mua Dec 2025 |

> Invested: 930.4M | Returned: 180M (Jan 2026) | **Net: 750.4M** (cost basis)
...
### 🏛️ Fund (VCBF) — ~594,063,000 ₫ *(cost basis)*

| Giai đoạn | Đầu tư |
|-----------|-------|
| Dec 2025 | 320M + 20M (2 đợt) |
| Feb 2026 | 127M (nhiều đợt) |
| Apr 2026 | 100M + 26.3M |

> Invested: 594M | Returned: 0 | **Net: 594M**

### 📊 Cổ tức stocks (FPTS) — ~236,136,000 ₫ *(cost basis)*

Đầu tư qua FPTS brokerage — mix dividend stocks + nhỏ ETF.

| | Đầu tư | Nhận về | Net |
|-|--------|---------|-----|
| VEA (VEAM cổ tức) | ~375M | ~175.6M | ~199M |
| ADP (cổ tức) | 45M | 0 | 45M |
| ETF + Trend | 108M | 91.6M | ~16M |
| Tổng FPTS | 503.3M | 267.2M | **~236M** |

> Cổ tức lớn nhận về Jan 2026: 175.6M (VEA trả nợ). Vẫn còn position đang mua định kỳ.

### 🏛️ Fund (Finhay) — ~74,404,069 ₫ *(cost basis)*

| Giai đoạn | Đầu tư |
|-----------|-------|
| Dec 2025 | 70M |
| Jan–Feb 2026 | 4.4M (nhiều đợt nhỏ) |

> Invested: 74.4M | Returned: 0 | **Net: 74.4M**
...
## ETF vs Fund Breakdown

```
ETF + Fund + Cổ tức = ~1,655M (cost basis)
├── 📈 ETF (VCBS)        ████████████████████         45.3%   (750M)  VN30/VN100/VN1000
├── 🏛️ Fund (VCBF)       ████████████████             35.9%   (594M)  Managed fund
├── 📊 Cổ tức (FPTS)     ██████                       14.3%   (236M)  VEA+ADP+ETF
└── 🏛️ Fund (Finhay)     ██                            4.5%    (74M)  Finhay fund

By type:
├── ETF total            ~766M   (VCBS 750M + FPTS ETF 16M)
└── Fund total           ~668M   (VCBF 594M + Finhay 74M)
└── Cổ tức stocks        ~220M   (FPTS VEA+ADP, DCA định kỳ)
```
...
├── 🥇 Vàng          ██████                           10.3%    (817M)
├── 🏢 Cổ phiếu      █████                             7.6%    (600M)
├── 🏛️ Fund (VCBF)   █████                             7.5%    (594M)
├── 📊 Cổ tức FPTS   ██                                3.0%    (236M)
├── 💵 Tiền mặt      █                                 2.4%    (191M)
├── 🏛️ Fund Finhay   ▌                                 0.9%     (74M)
└── 💳 Nợ            ▏                                 0.3%     (25M)
```
...
- BĐS + ETF/Fund + Vàng + Cổ phiếu = **89.3%** — phần lớn tài sản kém thanh khoản
...
| Cổ phiếu/ETF/Fund | 27.6% | 30–50% | ✅ Hơi thấp nhưng đang tăng qua DCA |
| Vàng | 10.3% | 5–15% | ✅ Trong ngưỡng tốt |
| Tiết kiệm | 15.3% | 10–20% | ✅ Ổn |
| Tiền mặt | 2.4% | 5–10% | ⚠️ Thấp, cần tăng sau tháng 6 |
...
- **Cost basis vs market value**: totaldashboard (7,897M) thấp hơn cost-basis calc (~8,022M) ~125M — có thể là unrealized loss trên ETF/Fund positions.
- **ETF current P&L**: Cần check VCBS/FPTS app để biết P&L thực — MISA API không có giá thị trường.
- **FPTS "Cổ tức"** (VEA, ADP): Phân loại chưa rõ — là cổ phiếu dividend hay fund? Ảnh hưởng đến cách tính allocation chuẩn xác.

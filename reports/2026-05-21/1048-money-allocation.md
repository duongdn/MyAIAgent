...
### 🏢 Cổ phiếu — ~820,000,000 ₫

| | Giá trị (₫) | Loại |
|-|------------|------|
| Larion cổ phần | 600,000,000 | Cổ phần (cổ tức định kỳ) |
| FPTS — VEA (VEAM) | ~199,000,000 | Cổ phiếu dividend, DCA định kỳ |
| FPTS — ADP | ~45,000,000 | Cổ phiếu dividend |
| **Tổng** | **~844M** | *(~820M sau làm tròn)* |

> FPTS VEA: nhận cổ tức 175.6M Jan 2026, tiếp tục mua thêm định kỳ.

### 📈 ETF — ~766,448,575 ₫ *(cost basis)*

| Nguồn | Giá trị | Index |
|-------|---------|-------|
| VCBS | ~750M | VN30, VN100, VN1000 |
| FPTS ETF/Trend | ~16M | ETF Trend (nhỏ) |

> VCBS: Invested 930.4M | Returned 180M | Net 750M. DCA từ Dec 2025.
...
```
ETF + Fund = ~1,434M (cost basis)
├── 📈 ETF (VCBS)        ████████████████████████     53.4%   (766M)  VN30/VN100/VN1000 + Trend
├── 🏛️ Fund (VCBF)       ████████████████████         41.4%   (594M)  Managed fund
└── 🏛️ Fund (Finhay)     █████                         5.2%    (74M)  Finhay fund

Cổ phiếu (riêng) = ~820M
├── 🏢 Larion            ████████████████████         73.2%   (600M)  Cổ phần, cổ tức định kỳ
├── 🏢 FPTS VEA          ████████                     24.3%   (199M)  Dividend stock, DCA
└── 🏢 FPTS ADP          ██                            5.5%    (45M)  Dividend stock
```
...
- **Cost basis vs market value**: totaldashboard (7,897M) vs cost-basis calc (~7,946M) diff ~49M — likely unrealized loss trên ETF/Fund positions trong bối cảnh thị trường hiện tại.

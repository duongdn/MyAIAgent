...
- Tikop (misc small investment): 40,024,366 ₫
- Larion cổ phần (carry-forward, KHÔNG confirmed 14 ngày, kể từ 08-26): 800,000,000 ₫
...
### 0. Đối chiếu report gần nhất (09-08 → 09-09)
- **Kế hoạch "tăng cổ phiếu" từ 09-04 (chuyển 2 sổ tiết kiệm 1w 10M + 1m 100M sang cổ phiếu): VẪN CHƯA THỰC HIỆN.**
  - Sổ "1m" 100,000,000 ₫ (bắt đầu 08-10) — còn nguyên, **đáo hạn NGÀY MAI 2026-09-10**. Đây là điểm quyết định cuối cùng của kế hoạch cũ — nếu không hành động ngày mai, tiền nhiều khả năng tự rollover như "1w" đã làm.
...
|--------|--------|---------|
| Larion carry-forward không xác nhận 14 ngày | 🟡 Trung bình | 800M (9.8% gross) dựa trên số liệu cũ 08-26, không phải giá trị live — cần re-confirm sớm |
| Kế hoạch tăng cổ phiếu bị trễ, deadline mai | 🟡 Trung bình | Sổ "1m" 100M đáo hạn 09-10 — quyết định cuối cùng, nếu không hành động sẽ tự rollover như "1w" |
| Tập trung Investment (45% base) | 🟢 Thấp | Đã đa dạng qua 4 kênh (VCBS/VCBF/FPTS/Finhay) + Larion, không phải 1 mã đơn lẻ |
| Currency risk (Paypal USD) | 🟢 Thấp | 92.2M (~1.6% base), dưới ngưỡng 5% |
| Single asset (Nhà, nếu tính cả full view) | 🟢 Thấp | 43% full view nhưng loại trừ khỏi base đầu tư theo chuẩn |
...
- "tikcop 1w" 10.01M đáo hạn ~09-15 (rollover ngắn hạn, ít quan trọng).
- "tikcop 3 month" 100M đáo hạn ~10-10.
- Xác nhận lại giá trị Larion (800M carry-forward, đã 14 ngày chưa update).

### 5. Khuyến nghị
- **Ngắn hạn (30 ngày):** Quyết định NGAY khi "1m" (100M) đáo hạn mai (09-10) — chuyển vào ETF/Fund nếu mục tiêu vẫn là tăng tỷ trọng cổ phiếu, hoặc chủ động chọn tái tục nếu đổi ý (hiện Investment đã ở 45%, sát cận trên benchmark 30-50%).
- **Trung hạn (6–12 tháng):** Re-confirm giá trị Larion (đăng nhập app/broker) để loại bỏ rủi ro số liệu carry-forward kéo dài (nay 14 ngày).
- **Dài hạn (>1 năm):** Cân nhắc tăng nhẹ tỷ trọng BĐS đầu tư (hiện 18% vs benchmark 20-30%) nếu có cơ hội phù hợp, tận dụng phần tiết kiệm dư (21.3% vs 10-20%).

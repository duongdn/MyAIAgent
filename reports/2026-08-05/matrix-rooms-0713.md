# Matrix — since 2026-08-04 08:00 +07:00
...
### !oofREYAXHsvPWEOJev:nustechnology.com — 2 messages
  [08:52] duongdn: đã tiến hành lesson learn với bạn nha
  [08:53] thuyltt: okie, thanks Dương
...
### Arthur - Meta-Stamp — 108 messages
  [08:53] namtv: Tình hình sao rồi anh em?
  [08:58] phucvt: Nay chưa thấy ổng reply á anh. Để e nhắn push ổng
  [08:58] phucvt: Còn về in-scope thì em với anh Tiến đã check và phản hồi ổng luôn rồi anh
...
### Celine - OhCleo — 200 messages
  [08:38] longvv: https://trello.com/c/ziws1Opk/195-%F0%9F%93%A9-popup-anonymous-newsletter-entry Hung Pham a test ticket này trên staging [thread: 73 replies]
    └ [10:27] longvv: Hung Pham: check giúp e sớm nha a ới
    └ [10:27] hungpn: cần xong sớm hả em
    └ [10:27] longvv: đúng r á, xong sớm để release cho bả
    └ [10:28] hungpn: vậy sau em báo thêm thông tin nha, để anh biết check sớm
    └ [10:30] hungpn: Long Vo: vẫn sài cái link trang hôm qua đúng k
    └ [10:30] longvv: hong, a check dựa vô điều kiện trong task á
    └ [10:30] longvv: user ở site quá 65s > show popup
    └ [10:31] longvv: hoặc ngta ghé 5 trang track
    └ [10:38] hungpn: Long Vo: user nhấn tắt pop-up đi thì cũng bị ẩn 7 ngày hả em
    └ [10:38] longvv: đúng r á
    └ [10:38] hungpn: nút "x" nha
    └ [10:39] hungpn: hok fai button Not now
    └ [10:40] longvv: Clicking "Not Now" hides the popup for 7 days.
    └ [10:40] hungpn: anh nói là nút X
    └ [10:40] hungpn: có gióng nhau hok
    └ [10:41] longvv: e thấy ko đề cập gì á
    └ [10:41] longvv: chủ yếu là
    └ [10:41] hungpn: thì anh mới hỏi nè
    └ [10:41] longvv: close cái modal đó là ẩn 7 ngày
    └ [10:41] longvv: cùng tính năng
    └ [10:41] hungpn: anh cũng k chắc
    └ [10:41] longvv: nên là cả 2 nút giống nhau
    └ [10:45] hungpn: Screencast From 2026-08-04 10-43-13.mp4
    └ [10:45] hungpn: có cái case này lần đầu tiên nè Minh Trinh thì chắc vẫn ổn nhỉ? chị bị lần duy nhất khi vào page nếu
    └ [10:46] hungpn: mà Long Vo cái video của anh thì anh vào lần thứ 2 mới hiện cái popup đó á
    └ [10:47] longvv: mà anh ở trang lâu r đúng ko
    └ [10:47] hungpn: anh mới mở vào thôi
    └ [10:49] longvv: là anh đang expect nó như nào
    └ [10:49] hungpn: thì fai lần đầu tiên anh nghe 15s?
    └ [10:49] longvv: ko phải á
    └ [10:50] hungpn: vậy em expect sao?
    └ [10:50] longvv: Điều kiện popup hiển thị: - Active site trên 65s, có nghĩa là anh phải ở site đó trên 65s giây, ở pa
    └ [10:51] longvv: anh cứ bật ẩn danh test
    └ [10:51] hungpn: vậy nếu anh vào 1 trang xong nghe 15s lần 1 nó k hiển thị ak?
    └ [10:53] minhtv: Nó hơi lòng vòng  Vậy suggest là nếu popup  Newsletter chưa hiện lần nào thì 15s lần đầu sẽ hiện nó 
    └ [10:54] longvv: à còn cái preview 15s nữa, e sót
    └ [10:55] longvv: mà e nhớ làm r, để check xem
    └ [10:55] longvv: mà track nào a play preview dc
    └ [10:55] hungpn: vào track nào mà k log in thì đều nghe dc 15s mà
    └ [10:57] longvv: oh để e check case 15s
    └ [10:57] longvv: a check 2 case khác xem ok ko
    └ [10:57] hungpn: rồi thêm cái nữa, user nhập email thì nó add cái email vào chỗ nào trên Sendgrid á em
    └ [10:58] hungpn: image.png
    └ [10:58] longvv: thêm vào non-signup
    └ [10:58] hungpn: ua? non-signup hok fai sài cho thèn hôm qua gì em nói à
    └ [10:58] hungpn: nó là 1 hả?
    └ [10:59] longvv: nó là 1 á
    └ [11:01] hungpn: cái ghé 5 lần anh thấy chưa chạy đúng nè, anh vào 5 lần liên tục mà chưa đủ 65s thì nó cũng k hiển t
    └ [11:01] longvv: a vào đúng trang track ko đó
    └ [11:01] longvv: e test bth
    └ [11:02] longvv: hoặc a vô trang https://staging.ohcleo.com/trackdetail/meeting rồi a f5 5 lần là dc
    └ [11:08] hungpn: image.png
    └ [11:08] hungpn: chắc em fai chặn user không cho đóng po-up ở màn hình này nếu click vào những khoảng mà anh khoanh đ
    └ [11:09] longvv: ok de e block click outside
    └ [11:25] hungpn: sao mà add user vào cía Sendgrid nó lâu vậy ta
    └ [11:25] longvv: phải đợi á a
    └ [11:25] longvv: tui nó queue, chắc 1h chạy 1 lần
    └ [11:25] longvv: mà nó có nút refresh
    └ [11:26] hungpn: những cũng k thấy user mới của anh đâu cả
    └ [11:26] longvv: a xài đi, mà cho click 1 lần 1 tiếng à
    └ [11:26] hungpn: ui chà, có rồi nè
    └ [11:31] longvv: Preview 15s với vụ chặn user ko cho đóng popup e update r nha
    └ [11:31] longvv: a check nhé
    └ [11:38] hungpn: okie rồi đó nè
    └ [11:39] hungpn: con cái vụ remove user ra khỏi cái list Sendgrid đợi hơi lâu
    └ [11:39] hungpn: để anh check lại cái này xong anh báo nhé
    └ [11:39] longvv: ok a
    └ [11:39] hungpn: khi user đk tài khoản xong thì fai remove user ra khỏi list non-signup đúng k Long Vo em làm rồi nhỉ
    └ [11:40] longvv: đúng r nha a
    └ [11:40] longvv: nó đăng kí thì chuyển qua segment khác
    └ [11:40] hungpn: okie em, đợi 1 tiếng nữa nè
    └ [11:40] longvv: :))
    └ [13:35] hungpn: tested DONE nha Long Vo
...
### Marcel - XID — 44 messages
  [08:39] duongdn: E đọc lai cẩm nang về tracker  summary lại các action cần lưu ý với nó nha, gởi lên đây, xem như lesson learn cho issue 
  [08:49] longvv: - Sử dụng đúng mục đích: Chỉ làm việc liên quan đến đúng dự án. - Nếu screenshot có nội dung không được phép khách hàng 
  [08:51] duongdn: OK e thêm lưu ý + Để memo phù hợp với công việc, cố gắng thay đổi memo chi tiết hơn + Duy trì chuột, bàn phìm để tăng ac
...
### MCP training — 8 messages
  [08:41] phucvt: Hi anh Duong Doan. Hôm trước em có tổng hợp được cái ý và mấy tài liệu này. Anh xem có thể tham khảo được không nha. Off
  [08:41] phucvt: * Hi anh Duong Doan. Hôm trước em có tổng hợp được cái ý và mấy tài liệu này. Anh xem có thể tham khảo được không nha. O
  [08:42] duongdn: ok, để a tạo 1 google doc liên quan, đầu tiên cần làm cái outline traing, tí a gởi lên rồi e comment xem cần update gì
  [08:42] phucvt: * Hi anh Duong Doan. Hôm trước em có tổng hợp được cái ý và mấy tài liệu này. Anh xem có thể tham khảo được không nha. O
  [08:52] duongdn: https://drive.google.com/drive/u/0/folders/1zlPJNAtuTmNgVSzby-PnR8laEe6CO5ga
  [08:52] duongdn: đây là thư mục
  [08:52] duongdn: https://docs.google.com/document/d/1HAjMLhWDzlxg7aNatrsAz9k58m2tlKQMMPeg1YsvMSk/edit?tab=t.0 Step 1 là file này nha

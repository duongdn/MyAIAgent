...
Robo-advisor (Tikop): 195,024,366 ₫
...
- Emergency reserve (Liquid + Savings, 1,231.7M₫) is ~17.6× the assumed 6-month expense target (420M₫) — very strong liquidity buffer, no forced-sale risk.
- Gold allocation (9.6% gross / 14.1% ex-home) is a sensible inflation hedge and is itself liquid-ish (tradeable).

### 2. Rủi ro (Risks)
| Risk | Severity | Detail |
|------|----------|--------|
| Real estate concentration | 🔴 Cao | 44.70% of gross assets (>40% threshold); "Nhà" alone is 31.99% of net worth, over the 25% single-asset flag. Mitigated by: it's the primary residence, illiquid by nature and not typically "rebalanced" — but it does mean over 40% of net worth carries zero market liquidity. |
...
|------|---------------------:|-----------|:------:|
| Bất động sản | 44.70% | 20–30% | ⚠️ Over |
| Cổ phiếu/ETF/Fund | 30.04% | 30–50% | ✅ |
| Trái phiếu/Tiết kiệm | 13.22% | 10–20% | ✅ |
| Vàng/Commodity | 9.61% | 5–15% | ✅ |
...
- Track "investable" allocation (ex-home) as the primary rebalancing lens — the home skews headline % without being actionable; the ex-home view (Investment 44%, Savings 19%, Gold 14%, RE-land 19%, Liquid 4%) is closer to a workable target mix already.
...
**Long-term (>1 year):**
- Set an explicit target-allocation policy with rebalance bands for the ex-home portfolio (e.g., Investment 40% / Savings 20% / Gold 10-15% / Liquid 10% / Land 15-20%) and review quarterly.

...
`Tikop` (195,024,366 ₫) reclassified from 📈 Investment → 💵 Liquid per user correction 2026-07-06 — it's a robo-savings/cash-parking product, not a growth investment like VCBS/VCBF/FPTS/Finhay.
...
| Account | Balance (₫) | % of investable (excl. Nhà) | Category | Tổng nhóm (₫) / % nhóm |
|---------|------------:|------:|----------|------:|
| long an res (inactive) | 1,020,000,000 | 18.98% | 🏠 Real Estate | **1,020,000,000 / 18.98%** |
| Larion cổ phần (inactive) | 600,000,000 | 11.17% | 📈 Investment | **2,170,758,840 / 40.40%** |
...
| vcb 1 month (savings) | 503,977,053 | 9.38% | 🏦 Savings | **1,038,686,927 / 19.33%** |
...
| ~~nam á 6m (savings) — 2,005,479~~ | — | — | 🐛 EXCLUDED (ghost, see Alerts) | (not in subtotal) |
| vàng (inactive) | 757,000,000 | 14.09% | 🥇 Gold | **757,000,000 / 14.09%** |
| Tikop | 195,024,366 | 3.63% | 💵 Liquid | **386,341,799 / 7.19%** |
...
| VCB visa | −61,000,000 | −1.14% | 💳 Debt | **−61,000,000 / −1.14%** |

(↑ = same as row above, one subtotal per category. Debt shown separately, not netted into the other subtotals.)
...
| 📈 Investment | 2,170,758,840 | 27.57% | 27.79% |
| 🏦 Savings | 1,038,686,927 | 13.19% | 13.30% |
| 🥇 Gold | 757,000,000 | 9.62% | 9.69% |
| 💵 Liquid | 386,341,799 | 4.91% | 4.95% |
...
## Liquidity Check
Instantly accessible (Liquid, incl. Tikop): 386,341,799 ₫
...
- ✅ Liquidity: Liquid (386.3M, incl. Tikop) alone covers ~5.5× monthly expense (70M); Liquid+Savings (1,425.0M) covers ~20.4× — well above 3× target

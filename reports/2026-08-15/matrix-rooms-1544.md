# Matrix — since 2026-08-07 00:00 +07:00

### Kunal - Fountain — 284 messages
  [11:01] hungpn: trước mình đưa cái hover lên live infinity chưa Dat Nguyen nhỉ?
  [11:01] hungpn: image.png
  [11:01] datnt: Chưa đâu anh
  [11:02] hungpn: okie em, làm anh giật mình =))
  [11:49] thinht: Hung Pham: rãnh test lại toàn bộ workflow giftofchoice trên staging có ổn k nhan. có update nhẹ
  [11:49] hungpn: giờ check nhé
  [11:55] hungpn: thấy live lấy đúng giá nè [thread: 2 replies]
    └ [13:20] thinht: bug infinity nãy báo pk
    └ [13:40] hungpn: đúng rồi
  [14:03] vutq: https://trello.com/c/B7uPm1Pq/2954-infinity-item-extras cái này lên LIVE rồi nha mn Hung Pham Vi Tran
  [14:03] vitht: để c test
  [14:38] vitht: mới phát hiện ra bug nữa rồi ở trang cart cái item nó không hiện thêm cái giá của extra item
  [14:38] vitht: Screenshot 2026-08-07 at 2.38.28 pm.png
  [14:55] vitht: Ae QC chú ý: Nếu feature nào mà mới deploy lên live 10' sau mới test lại nha. Chứ nó dính cache lấy data cũ mặc dù mình 
  [14:55] vitht: 😆
  [15:03] hungpn: NOTED nha [thread: 1 reply]
    └ [15:05] thinht: nhớ check cái GiftOfChoice nha
  [15:07] vitht: e add cái extra item dô cái gift test lun nha a Hùng, e coi nó hiện giá đúng không
  [15:26] vitht: Vu Tat:  ơi review với deploy này giúp c lên live với  https://github.com/iamksheth/FountainNewUI/pull/508 [thread: 2 replies]
    └ [15:32] vutq: done nha chị
    └ [15:47] vitht: để c test lại lần nữa

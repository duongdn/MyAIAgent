# Matrix — since 2026-08-17 00:00 +07:00

### Kunal - Fountain — 157 messages
  [10:19] trinhmtt: Em gửi plan tuần này ạ  ThinhT: 20h ViTHT: 40h DatNT: 36h
  [10:19] trinhmtt: * Em gửi plan tuần này ạ  ThinhT: 20h ViTHT: 40h DatNT: 36h => QC: 24h
  [12:33] datnt: 
  [14:57] datnt: Vu Tat anh ơi anh review giúp em PR này nha  - #[2896](https://trello.com/c/BSrIHSmc/2869-fountain-order-flow-message-re [thread: 1 reply]
    └ [15:36] vutq: done nha Dat Nguyen
  [15:29] vitht: ông Kunal kêu push này lên live nè Dat Nguyen  oi  https://trello.com/c/lbWnX6N0/2870-infinity-order-flow-updates?filter [thread: 1 reply]
    └ [15:31] datnt: dạ oki chị cái đó để em self review với nhánh master rồi em đưa lại cho anh Vũ sau nha chị
  [17:11] vitht: card này lên BETA rồi nha ae ơi  https://trello.com/c/gnw4qAwO/3023-infinity-update-preview-giftdrop-button-with-new-rec
  [17:11] vitht: * card này lên BETA rồi nha ae ơi  https://trello.com/c/gnw4qAwO/3023-infinity-update-preview-giftdrop-button-with-new-r
  [17:30] thinht: https://trello.com/c/Zdd0nsTn/2962-infinity-blog a update phần feedback nó lên BETA rồi nha Phat Le
  [08:26] datnt: Vu Tat anh ơi, anh review giúp em PR này lên LIVE nha https://trello.com/c/1v99NCmM/2939-infinity-roses-update-rose-colo [thread: 1 reply]
    └ [09:29] vutq: done nha Dat Nguyen
  [08:41] vitht: Ae ơi ông Kunal nói cái bên Done (Live) dài lắm rồi, có gì đưa lên live thì kéo qua cột Done v2 nha  https://trello.com/
  ...
  [08:36] datnt: Hung Pham anh ơi cái này anh test trong ngày rồi mà phải không anh [thread: 3 replies]
    └ [08:54] hungpn: đúng rồi
    └ [08:59] datnt: ở beta cái dialog anh check case user không bấm review mà bấm tắt dialog á
    └ [08:59] datnt: thì cái ngày ship nó tự động update lên chưa anh
  [08:36] datnt: https://trello.com/c/oHJ5YO8y/2380-finding-solution-to-customers-receiving-incorrect-delivery-dates-in-the-delivery-tab-
  [08:37] datnt: * Hung Pham anh ơi cái này anh test order sau 1h30pm các ngày thứ 2, 3, 4, 5 rồi mà phải không anh
  [11:03] datnt: Hung Pham anh test lại card này nha https://trello.com/c/oHJ5YO8y/2380-finding-solution-to-customers-receiving-incorrect [thread: 9 replies]
    └ [15:58] hungpn: okie em
    └ [15:59] hungpn: tính ra bữa check cái này cũng thấy hợp lý nên dể lại, hóa ra cux cũng k thích điều này
    └ [16:00] hungpn: anh check xong rooif nha Dat Nguyen
    └ [16:01] datnt: dạ oki anh
    └ [16:04] datnt: Vu Tat anh ơi check giúp em PR này nha #[2380](https://trello.com/c/oHJ5YO8y/2380-finding-solution-t
    └ [16:06] vutq: đợt này BE chuẩn rồi hả Dat Nguyen, mình chỉ cần update FE thôi?
    └ [16:06] datnt: BE còn nhiều cái khó nói lắm anh
    └ [16:06] datnt: cái FE này em handle trước cái display cho Cus trước thôi á
    └ [16:09] vutq: done nha
  [11:04] datnt: * Hung Pham anh test lại card này nha https://trello.com/c/oHJ5YO8y/2380-finding-solution-to-customers-receiving-incorre
  [16:14] trinhmtt: em update Plan tuần này ạ  ViTHT: 40h ThinhT: 20h Vu Tat 4h DatNT: 36h => QC 25h
  [16:16] hungpn: tessted DONE nha Dat Nguyen
  [16:19] datnt: Vu Tat anh check giúp em PR này luôn nha #[3031](https://trello.com/c/HnI9nrhN/3031-infinity-roses-product-position): ht [thread: 5 replies]
    └ [16:28] vutq: done nha Dat Nguyen
    └ [16:31] datnt: à em quên
    └ [16:31] datnt: anh clear cache giúp em với lun
    └ [16:32] datnt: chứ khong nó vẫn bắt cache cũ ở Rails á
    └ [16:34] vutq: done nha
  [16:28] vutq: Hi mn, Vi Tran Thinh Tran Dat Nguyen hiện tại vì mình đang việc check user cookie trên navbar, nên khi build production 
  [16:28] vutq: * Hi mn, Vi Tran Thinh Tran Dat Nguyen hiện tại vì mình đang check user cookie trên navbar, nên khi build production - m
  [16:28] vutq: * Hi mn, Vi Tran Thinh Tran Dat Nguyen hiện tại vì mình đang check user cookie trên navbar, nên khi build production - m
  [16:37] trinhmtt: Em add vào note roi nha mn
  [10:27] datnt: Hung Pham card này em apply cho Infinity rồi nha anh, có gì anh QC giúp em nha https://trello.com/c/oHJ5YO8y/2380-findin
  [10:28] datnt: Cả card này em cũng lên beta rồi nha https://trello.com/c/IiBUGzVE/3021-account-scoped-products-pinned-ready-to-ship-gif
  [10:29] datnt: ủa anh chị ơi sao Live Infinity
  [10:29] datnt: mất tiêu cái footer rồi
  [10:29] datnt: image.png
  [10:31] vitht: hay quá ta. Mất hùi nào k hay lun :v
  [10:32] vitht: qua page khác vẫn còn á
  [10:33] datnt: để xíu em update lại lun chị ơi, em đang sắp trống card rồi 🫠
  [10:38] datnt: Trinh Mai chị ơi Kunal ổng dí card này chị ơi 🥲 https://trello.com/c/IiBUGzVE/3021-account-scoped-products-pinned-ready
  [10:40] trinhmtt: em chia ra live của cái giftbox trước đc k, cái catalog chưa test mà
  [10:41] datnt: dạ oki chị để em xem chia ra
  [10:44] trinhmtt: https://trello.com/c/IiBUGzVE/3021-account-scoped-products-pinned-ready-to-ship-gifts-private-build-a-box-items Hung Pha
  [14:23] datnt: Vu Tat anh check PR này giúp em nha https://trello.com/c/IiBUGzVE/3021-account-scoped-products-pinned-ready-to-ship-gift

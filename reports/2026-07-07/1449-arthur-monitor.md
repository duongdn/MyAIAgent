...
| 4g | Bug #7 — Xác nhận demo account có tiền thật | 🟢 Đã làm rõ + đáp ứng | 🟢 Dùng thẻ test Stripe luôn đủ tiền, tự động charge $5/pull | 07/7 15:03 | Vẫn là sandbox key (kế hoạch: chuyển key thật sau demo) | [Nick giải thích](https://solid-code-team.slack.com/archives/C0B4G8USU3D/p1783411386022709) |

# Matrix — since 2026-07-24 07:00 +07:00

### Kunal - Fountain — 190 messages
  ...
  [16:56] thinht: https://trello.com/c/xIukJjhO/2955-infinity-account-and-auth ticket này lên staging r nha Hung Pham [thread: 4 replies]
    └ [11:58] hungpn: fix bug nha Thinh Tran
    └ [11:59] thinht: bug j, redmine ah
    └ [11:59] hungpn: đúng rồi
    └ [12:00] thinht: 👍️👍️
  ...
  [08:26] datnt: Hung Pham anh ơi anh QC giúp em cái ấn 2 lần button continues ở khúc chọn delivery để add to cart Build a Box nha anh mà [thread: 6 replies]
    └ [09:11] hungpn: sẵn tiện em đang fix mấy cái liên quan tới button thì chắc fix luôn em này
    └ [09:11] hungpn: image.png
    └ [09:12] datnt: này nó bị sai UI hay sao á anh
    └ [09:14] hungpn: nó cho user nhấn dup nh lần đó nè
    └ [09:14] datnt: à oki anh, vậy để em fix cái này luôn
    └ [11:43] datnt: Hung Pham cái này em fix lên beta rồi nha anh, có gì anh test lại nha
  [08:27] datnt: cái bug mà trưa hôm qua em nhờ anh test bên Fountain á anh test lại giúp em bên Beta Infinity nha
  [08:31] datnt: với card này trên Live nó đang thiếu button `Submit` với `Share link` trên trang productcatalog khi chuyển sang Pro á em
  [08:43] hungpn: để anh check nè
  [10:05] thinht: https://github.com/iamksheth/FountainGreetings/pull/463 Vu Tat xem qua zúp a PR này fix cho rollbar nha e. [thread: 1 reply]
    └ [14:26] vutq: done nha anh Thinh Tran
  [10:11] datnt: Hung Pham anh ơi card này em fix xong feedback rồi nha, có gì anh QC giúp em nha https://trello.com/c/BSrIHSmc/2869-foun
  [10:12] hungpn: 2 cía lúc sáng em báo anh check done nha Dat Nguyen [thread: 1 reply]
    └ [10:13] datnt: dạ oki anh 🫡
  [10:15] datnt: Vu Tat anh ơi anh check giúp em 2 PR này nha - Cái này cho vụ ấn button 2 lần khi add to cart, em đưa apply qua Infinity [thread: 1 reply]
    └ [10:33] vutq: done nha Dat Nguyen
  [14:48] hungpn: cái blank page fix chưa Vi Tran
  [14:48] hungpn: * cái blank page bên Infinity fix chưa Vi Tran
  [14:50] vitht: chưa á a
  [14:50] vitht: bữa e fix cho infinity rồi á
  [14:50] vitht: a check lại xem được chưa, e chưa coi lại
  [14:50] vitht: https://trello.com/c/B7uPm1Pq/2954-infinity-item-extras
  [14:50] vitht: ổng add cmt trong card này nè
  [14:54] hungpn: này em cứ add 1 item vào cart, user fai login nha. Xong đợi hết time-out rồi nhấn checkout là bị
  [14:54] hungpn: chắc bữa em fix bên Fountains á chứ bên Infinity chưa á
  [14:57] vitht: Dạ để e làm xong task 2813 rồi e qua task này thử
  [14:58] vitht: mà mấy card khác a test xong hết rồi hả, hay có card nào dính tới bug này hả a

// Slack scan for 2026-06-22 (Monday) daily report — piece B
// Workspaces: Generator, LegalAtoms, MPFC, William Bills, Equanimity, Aigile Dev
// Window: Friday 2026-06-19T08:00+07 -> now
...
const WINDOW_EPOCH = new Date("2026-06-19T08:00:00+07:00").getTime() / 1000;
const SEARCH_AFTER = "2026-06-18"; // after: excludes this date -> returns June 19+
const TARGET_WORKSPACES = ["Generator", "LegalAtoms", "MyPersonalFootballCoach", "William Bills", "Equanimity", "Aigile Dev"];

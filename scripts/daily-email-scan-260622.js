// Daily email scan for 2026-06-22 (Monday) — window: 2026-06-19T08:00+07 → now
...
const WINDOW_START = new Date("2026-06-19T08:00:00+07:00");
const IMAP_SINCE = "18-Jun-2026"; // day before window start (server calendar date)

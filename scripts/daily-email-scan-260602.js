// Daily email scan for 2026-06-02 — window: 2026-05-29T08:00+07 → now (Monday rule: from last Friday 8AM)
const tls = require("tls");
const accounts = require("../config/.email-accounts.json").accounts;

const WINDOW_START = new Date("2026-05-29T08:00:00+07:00");
...
// Per-account content filters (in addition to alert keywords)

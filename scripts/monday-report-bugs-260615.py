#!/usr/bin/env python3
"""Fetch Redmine bugs and Slack external bugs for Monday report week 2026-06-08 to 2026-06-14.
Does NOT submit forms or modify Trello.
"""
...
# Window: Mon 2026-06-08 00:00 +07 to Sun 2026-06-14 23:59 +07
# after: excludes the date itself, so use 2026-06-07 to include Jun 8
# before: excludes the date, so use 2026-06-15 to include Jun 14
SLACK_DATE_QUERY = "after:2026-06-07 before:2026-06-15"
# Unix timestamps for filtering (UTC+7 = UTC-7h)
TS_LO = 1749304800  # 2026-06-08 00:00:00 +07
TS_HI = 1749909599  # 2026-06-14 23:59:59 +07

def redmine_bugs(project_id):
    """Count bugs created in the reporting week."""
    # created_on: ><startdate|enddate (ISO dates)
    params = urllib.parse.urlencode({
        'project_id': project_id,
        'tracker_id': 1,
        'created_on': '><2026-06-08|2026-06-14',
        'limit': 100,
    })
...
# ─── REDMINE BUGS ─────────────────────────────────────────────────────────────
print("\n=== REDMINE BUGS (2026-06-08 to 2026-06-14) ===")
redmine_results = {}
for name, proj_id in [
...
# Filter for actual bug/issue content
...
baam_msgs = slack_search("Baamboozle",
...
legal_msgs = slack_search("LegalAtoms",

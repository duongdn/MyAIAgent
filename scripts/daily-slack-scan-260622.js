// Slack scan for 2026-06-22 (Monday) daily report — window: 2026-06-19T08:00+07 (Fri) → now
...
async function searchWorkspace(ws) {
  ...
  const url = `https://slack.com/api/search.messages?query=${encodeURIComponent(query)}&count=30&sort=timestamp&sort_dir=desc`;

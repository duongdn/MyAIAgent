#!/usr/bin/env python3
"""Slack scan for 2026-04-29 daily report.
Window: 2026-04-28 08:30 +07 -> now.
"""
import json
import os
import time
...
CUTOFF_EPOCH = 1745803800  # 2026-04-28 08:30:00 +07:00
QUERY = "after:2026-04-27"  # slack `after:` excludes named date
...
if __name__ == "__main__":
    print(f"# Slack Scan — {time.strftime('%Y-%m-%d %H:%M:%S %Z')}")
    print(f"Cutoff: 2026-04-28 08:30:00 +07 (epoch {CUTOFF_EPOCH})")
    print(f"Query: {QUERY}")
    print()

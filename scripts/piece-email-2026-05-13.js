// Email scan for daily report 2026-05-13
// Window: 2026-05-12T08:58:35+07:00 -> now
const tls = require("tls");
const accounts = require("../config/.email-accounts.json").accounts;

const windowStart = new Date("2026-05-12T08:58:35+07:00");
  ...
  return new Promise((resolve) => {
    ...
    socket.on("data", (data) => {
      ...
      if (step === 2 && /A2 (OK|NO|BAD)/i.test(buffer)) {
        ...
        step = 3; buffer = "";
        // SINCE 11-May-2026 to catch UTC+7 window starting 2026-05-12 (UTC = 2026-05-11 01:58)
        send("A3", "SEARCH SINCE 11-May-2026");
        return;
      }

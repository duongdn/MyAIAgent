// Daily Slack scan for 2026-06-05 — window: 2026-06-04T09:10+07 → now
...
const WINDOW_EPOCH = new Date("2026-06-04T09:10:00+07:00").getTime() / 1000;
const SEARCH_AFTER = "2026-06-03"; // after: excludes this date → returns June 4+

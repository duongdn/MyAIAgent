"""Weekly hours fetch for week of 2026-05-04 to 2026-05-08 (W25 reference, week of May 04).
...
TARGET_MONDAY_PATTERNS = ['May 4, 2026', 'May 04, 2026', 'May 4', 'May 04']
...
SHEETS = {
    ...
    'fountain':        ('1iIKfjAh857qzrR2xkUWPcN_9bFAwB1pL8aJWTRk4f4o', ['VuTQ', 'ThinhT', 'ViTHT', 'PhatDLT', 'HungPN', 'HaVS', 'DatNT']),
...
def find_week_tab(sid):
    try:
        r = svc.values().get(spreadsheetId=sid, range='Summary!A4:BZ200').execute()
...
print(f'=== Weekly Hours Fetch — W of 2026-05-04 ===\n')
...
for label, (sid, employees) in SHEETS.items():
    ...
    if err:
        ...
        continue
    if not week:
        print(f'[{label}] Week starting May 04 NOT found in Summary\n')
        continue
...
with open('/tmp/weekly-2026-05-04.json', 'w') as fh:
    json.dump(results, fh, indent=2, default=str)
print('\nWrote /tmp/weekly-2026-05-04.json')

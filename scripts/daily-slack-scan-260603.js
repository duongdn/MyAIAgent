// Daily Slack scan for 2026-06-03 — window: 2026-06-02T18:42+07 → now
...
const WINDOW_EPOCH = new Date("2026-06-02T18:42:00+07:00").getTime() / 1000;
const SEARCH_AFTER = "2026-06-01"; // after: excludes this date → returns June 2+
...
const XOXC_REFRESH_SCRIPTS = {
  "Amazing Meds": "slack-amazingmeds-refresh-tmp.js",

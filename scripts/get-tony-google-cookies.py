#!/usr/bin/env python3
"""
Extract Google account session cookies from Chrome Profile 25 (Tony Bui, tony@nustechnology.com).
Used to let a headless Puppeteer session complete "Sign in with Google" silently for
new Slack workspaces Tony hasn't logged into via that profile yet.
Outputs JSON array to /tmp/tony-google-cookies.json.
"""
...
OUT_FILE    = '/tmp/tony-google-cookies.json'

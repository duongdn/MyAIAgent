#!/usr/bin/env python3
"""Weekly sheets scan for W31 (June 15-19, 2026). Run: 2026-06-20 (Saturday).
...
# W31 target: June 15 (Mon) - June 19 (Fri) 2026
...
def get_wtab_owner_totals(sheet_id, week_tab):
    ...
    for row in rows:
        ...
        # Task row — check col A OR col G (owner) has value (fixes empty col A bug)
...
# ── Discover tabs ──────────────────────────────────────────────────────────────
print("\n=== Discovering W31 tabs (target: 2026-06-15) ===", file=sys.stderr)
tabs = {}
...
results = {"tabs": tabs, "week": "W31 (Jun 15-19, 2026)"}
...
if aysar_tab:
    ...
    # Aysar sheet owner = KhanhHH; if no explicit KhanhHH owner match, sum all

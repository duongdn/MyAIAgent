// Email scan for daily report 2026-05-08
// Window: 2026-05-07T08:37:42+07 -> 2026-05-08T08:30:00+07
const tls = require("tls");
const accounts = require("../config/.email-accounts.json").accounts;

const windowStart = new Date("2026-05-07T08:37:42+07:00");
const windowEnd   = new Date("2026-05-08T08:30:00+07:00");
  ...
  return new Promise((resolve) => {
    ...
    socket.on("data", (data) => {
      ...
      if (step === 2 && /A2 (OK|NO|BAD)/i.test(buffer)) {
        ...
        step = 3; buffer = "";
        send("A3", "SEARCH SINCE 7-May-2026");
        return;
      }

// Slack scan for 2026-06-10 daily report — window: 2026-06-09T09:46+07 → now
...
const WINDOW_EPOCH = new Date("2026-06-09T09:46:00+07:00").getTime() / 1000;
const SEARCH_AFTER = "2026-06-08"; // after: excludes this date → returns June 9+

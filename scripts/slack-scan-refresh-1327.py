#!/usr/bin/env python3
"""Slack refresh scan for 2026-04-24 13:27 refresh.
Window: 2026-04-24 09:05 +07 -> now.
"""
import json
import os
import time
...
CUTOFF_EPOCH = 1776996300  # 2026-04-24 09:05:00 +07:00
QUERY = "after:2026-04-23"  # slack `after:` excludes named date
...
if __name__ == "__main__":
    ...
    print(f"Cutoff: 2026-04-24 09:05:00 +07 (epoch {CUTOFF_EPOCH})")
    print(f"Query: {QUERY}")
    print()

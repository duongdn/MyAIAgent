#!/usr/bin/env node
/**
 * Daily sheets scan for 2026-06-20 (Saturday) — checking June 19 (PREV_DATE, Friday) hours.
 * W28 (June 15-21, 2026).
...
// Jun 19 (PREV_DATE, Friday) — what we scan for hours
const PREV_TOKENS = ["Fri, 19/06/26", "19/06/26"];
const TARGET_DATE = new Date(2026, 5, 19); // June 19, 2026 — used for week tab discovery
const PREV_DATE   = new Date(2026, 5, 19); // June 19, 2026 — daily hours to report
...
const WS_DATE = "2026-06-19"; // Friday

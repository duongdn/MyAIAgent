...
const windowStart = new Date("2026-05-04T08:30:00+07:00");
const windowEnd   = new Date("2026-05-05T09:11:40+07:00");
  ...
  return new Promise((resolve) => {
    ...
    socket.on("data", (data) => {
      ...
      if (step === 2 && /A2 (OK|NO|BAD)/i.test(buffer)) {
        ...
        step = 3; buffer = "";
        // SINCE inclusive of 3-May for safety vs server tz
        send("A3", "SEARCH SINCE 3-May-2026");
        return;
      }

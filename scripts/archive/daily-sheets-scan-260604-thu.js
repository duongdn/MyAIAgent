#!/usr/bin/env node
/**
 * Daily sheets scan for 2026-06-04 (Thursday) — W29 (June 1-7, 2026).
...
const FALLBACK_TABS = {
  Maddy: "W9", JohnYi: "W27", Rebecca: "W27", JamesDiamond: "W28",
  Rory: "W14", Franc: "W27", Aysar: "W27", Generator: "W43",
  Paturevision: "W30", Elena: null,
};

const THU_TOKENS = ["Thu, 04/06/26", "04/06/26", "Thu, 4/06/26"];
const TARGET_DATE = new Date(2026, 5, 4); // June 4, 2026

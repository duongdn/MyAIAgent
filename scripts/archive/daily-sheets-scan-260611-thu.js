...
function extractDailyHoursByOwner(rows, tokens, hoursCol = 7) {
  ...
  for (let i = startIdx + 1; i < rows.length; i++) {
    ...
    // Also accept rows with empty col A that have an owner — devs sometimes omit col A
...
async function main() {
  ...
  results.LeNH = {
    ...
    note: "Aysar sheet owner=KhanhHH — excluded from LeNH",
  };

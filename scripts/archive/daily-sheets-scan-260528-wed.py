#!/usr/bin/env python3
"""Daily sheets scan for 2026-05-28 (Wednesday).
Checks Tuesday 2026-05-27 hours (W21, day 2 of current week May 25-29).

Week tabs (same as 260527 — week May 25-31):
  Maddy:        W8  (May 25-31)
...
# Date tokens for Tue May 27 2026
TUE_MAY27_TOKENS = ["Tue, 27/05/26", "27/05/26"]
...
results["TuanNT"] = {
    ...
    "totalHours": sum(tuannt_jy.values()) + sum(tuannt_rb.values()),
...
vietph_hours, pat_leave, pat_err = extract_daily_hours_by_owner(rows_pat, date_tokens)
results["VietPH"] = {
...
# --- LeNH: Rory + Franc + Aysar sheets ---
print("Checking LeNH (Rory+Franc+Aysar)...", file=sys.stderr)
...
# Also sum all non-empty owners from these sheets as fallback
if lenh_total == 0:
    lenh_total = (

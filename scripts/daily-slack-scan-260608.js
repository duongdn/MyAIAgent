// Slack scan for 2026-06-08 daily report — window: 2026-06-07T09:00+07 → now
...
const WINDOW_EPOCH = new Date("2026-06-07T09:00:00+07:00").getTime() / 1000;
const SEARCH_AFTER = "2026-06-06"; // after: excludes this date → returns June 7+
...
async function searchWorkspace(ws) {
  ...
  // Cookie stored with d= prefix already (xoxc accounts)

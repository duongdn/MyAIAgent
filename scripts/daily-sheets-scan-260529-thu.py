#!/usr/bin/env python3
"""Daily sheets scan for 2026-05-29 (Thursday).
Checks Thursday 2026-05-29 hours (W22, day 4 of current week May 25-31).

Week tabs (same week May 25-31 as Wed scan):
  Maddy:        W8  (May 25-31)
...
# Date tokens for Thu May 29 2026
THU_MAY29_TOKENS = ["Thu, 29/05/26", "29/05/26"]

#!/usr/bin/env node
/**
 * Daily sheets scan for 2026-06-17 (Wednesday) — checking June 16 (PREV_DATE, Tuesday) hours.
 * W28 (June 15-21, 2026).
 */
...
const PREV_TOKENS = ["Tue, 16/06/26", "16/06/26"];
const TARGET_DATE = new Date(2026, 5, 17); // June 17, 2026 — used for week tab discovery
const PREV_DATE   = new Date(2026, 5, 16); // June 16, 2026 — daily hours to report

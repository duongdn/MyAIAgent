#!/usr/bin/env python3
"""
Extract ALL Slack cookies from Chrome Profile 25 (used by slack-extract-ohcleo-token.js).
Outputs JSON array to /tmp/slack-all-cookies.json including device-trust cookies.
"""
...
OUT_FILE    = '/tmp/slack-all-cookies.json'

cookies = []
seen = set()
for domain in ['.slack.com', 'slack.com', 'ohcleo.slack.com', '.ohcleo.slack.com']:
    try:

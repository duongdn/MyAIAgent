// Daily email scan for 2026-06-03 — window: 2026-06-02T18:42+07 → now
const tls = require("tls");
const accounts = require("../config/.email-accounts.json").accounts;

const WINDOW_START = new Date("2026-06-02T18:42:00+07:00");
const IMAP_SINCE = "01-Jun-2026"; // safe to catch all, filter by Date in code

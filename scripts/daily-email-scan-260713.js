// Daily email scan — window: 2026-07-10T10:27+07 → now
...
const WINDOW_START = new Date("2026-07-10T10:27:00+07:00");
const IMAP_SINCE = "9-Jul-2026"; // day before window start (server calendar date)

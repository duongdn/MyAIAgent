#!/usr/bin/env python3
"""Weekly sheets scan for W30 (June 9-13, 2026). Run: 2026-06-06 (Saturday).
...
# W30 target: June 1 (Mon) - June 7 (Sun) 2026
TARGET_MONDAY = date(2026, 6, 9)
TARGET_FRIDAY = date(2026, 6, 13)
...
# ── Discover tabs ──────────────────────────────────────────────────────────────
print("\n=== Discovering W30 tabs (target: 2026-06-09) ===", file=sys.stderr)
tabs = {}
...
results = {"tabs": tabs, "week": "W30 (Jun 9-13, 2026)"}

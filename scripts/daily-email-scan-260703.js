// Daily email scan for 2026-07-03 — window: 2026-07-02T05:01+07 → now
...
const WINDOW_START = new Date("2026-07-02T05:01:00+07:00");
const IMAP_SINCE = "1-Jul-2026"; // day before window start (server calendar date)

#!/usr/bin/env python3
"""Weekly sheets scan for W31 (June 16-20, 2026). Run: 2026-06-19 (Thu partial — Fri to complete).
...
# W31: June 15 (Mon) - June 19 (Fri) 2026 — running Fri Jun 19 (end of week)
...
# ── Discover tabs ──────────────────────────────────────────────────────────────
print("\n=== Discovering W31 tabs (target: 2026-06-16) ===", file=sys.stderr)
tabs = {}
...
results = {"tabs": tabs, "week": "W31 (Jun 16-20, 2026)", "partial": True, "scanEnd": "2026-06-19 (Thu)"}
...
# ── VietPH: Paturevision (last week Jun 26) ────────────────────────────────────
...
results["TuanNT"] = {
    ...
    "charleschangOwners": cc_owners,
}

# ── KhanhHH: Generator + Elena (GSheets only; Baamboozle+Colin via Workstream) ─
...
results["KhanhHH"] = {
    ...
    "total": khanhhh_total,
    "target": 40,
    "note": "Baamboozle+Colin/ETZ via Workstream — not in GSheets scan",

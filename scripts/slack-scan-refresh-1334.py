#!/usr/bin/env python3
"""Slack refresh scan for 2026-04-20 13:34 refresh.
Window: 2026-04-20 08:40 +07 -> now.
"""
import json
import os
import time
...
CUTOFF_EPOCH = 1776584400  # 2026-04-20 08:40:00 +07:00
QUERY = "after:2026-04-19"  # slack `after:` excludes named date
...
if __name__ == "__main__":
    ...
    print(f"Cutoff: 2026-04-20 08:40:00 +07 (epoch {CUTOFF_EPOCH})")
    print(f"Query: {QUERY}")
    print()

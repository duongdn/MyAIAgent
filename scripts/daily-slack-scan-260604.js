// Daily Slack scan for 2026-06-04 — window: 2026-06-03T22:09+07 → now
...
const WINDOW_EPOCH = new Date("2026-06-03T22:09:00+07:00").getTime() / 1000;
const SEARCH_AFTER = "2026-06-02"; // after: excludes this date → returns June 3+
